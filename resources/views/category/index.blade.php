...
<div class="row align-items-center">
    <div class="col-sm-6">
        <div class="page-title-box">
            <h4 class="font-size-18">Kategori Yuran</h4>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div>
                ...
                <a style="margin: 19px; float: right;" href="{{ route('category.create') }}" class="btn btn-primary">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="categoryTable" class="table table-bordered table-striped dt-responsive nowrap"
      ...
      var categoryTable;
        ...
        function fetch_data(oid = '') {
            categoryTable = $('#categoryTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('category.getCategoryDatatable') }}",
                        data: {
                            oid: oid,
                        },
                        type: 'GET',
