    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="getIndexTransactionDatatable" class="table table-bordered table-striped dt-responsive"
...
<script>
    $( document ).ready(function() {
        ...
        function fetch_data(oid = '') {
            receiptTable = $('#getIndexTransactionDatatable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: {
                        url: "{{ route('recurring_fees.getIndexTransactionDatatable') }}",
                        data: {
                            oid: oid,
                        },
                        type: 'GET',
