...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div>
                <a style="margin: 19px; float: right;" href="{{ route('fees.createD') }}" class="btn btn-primary"> <i
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="categoryD" class="table table-bordered table-striped dt-responsive nowrap"
