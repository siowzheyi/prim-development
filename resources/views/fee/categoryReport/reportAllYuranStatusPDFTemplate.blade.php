                    ...
                    <div class="card-body py-5">
                        <div class="row">
                            <div class="col-12 pt-3">
                                <!-- <img src="/storage/app/public/organization-picture/smk2.png" alt="{{$organization->organization_picture}}" width="24" height="39">
                                <img src="{{ asset('img/' . $organization->organization_picture) }}" /> -->
                                <!-- <img src="/storage/app/public/organization-picture/abc.jpg" alt="{{$organization->organization_picture}}" width="24" height="39"/> -->
